...
| Customer | Current month | Prior month | Change | Notes |
|---|---|---|---|---|
| 1. | | | | |
| 2. | | | | |
| 3. | | | | |
...
> **Known data:** 20 Zoho invoices, 29 Exact dagboek 70 entries (12 verwerkt).
> Cross-period note: 7 February invoices are booked in period 1 — ensure revenue allocation is correct.
...
|---|---|---|---|---|---|---|
| Jan 2026 | IO260054 Sterk B.V. — manual sales entry | Dagboek 70 | EUR 663,96 | 70 | Direct Exact entry, no Zoho origin | Pending Finance Lead confirmation |

> **Known data:** Dagboek 90 (Memoriaal): 6 entries (5 te verwerken, 1 verwerkt). All manual memorial entries must be listed here once identified.
